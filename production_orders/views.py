...
class ProductionOrderListCreateView(APIView):
    ...
    def post(self, request):
        ...
        # ----------------------------------------------------
        # ONLY ACCOUNTANTS AND ADMINS CAN CREATE
        # ----------------------------------------------------
        ...
        if request.user.role not in [
            ...
            return Response(
                {
                    "detail": (
                        "Only accountants and admins can "
...
class ProductionOrderDetailView(APIView):
    ...
    def patch(self, request, pk):
        ...
        # Only accountants/admins can edit
        if request.user.role not in [
            "accountant",
            "admin",
        ]:
        ...
        # Do not allow editing an approved order
        if order.approved:
            return Response(
                {
                    "detail": (
                        "Approved production orders cannot "
                        "be edited."
                    )
                },
                status=status.HTTP_400_BAD_REQUEST,
    ...
    def delete(self, request, pk):
        ...
        # Only accountants/admins can delete
        if request.user.role not in [
            "accountant",
            "admin",
        ]:
        ...
        # Do not allow deleting approved orders
        if order.approved:
            return Response(
                {
                    "detail": (
...
class ProductionOrderApprovalView(APIView):
    ...
    def post(self, request, pk):
        ...
        # ----------------------------------------------------
        # ONLY ACCOUNTANTS AND ADMINS CAN APPROVE
        # ----------------------------------------------------
        ...
        if order.quotation and not order.quotation.approved:
            return Response(
                {
                    "detail": (
...
class CreateProductionOrderFromQuotationView(APIView):
    ...
    def post(self, request, quotation_id):
        ...
        # ----------------------------------------------------
        # PREVENT DUPLICATE PRODUCTION ORDER
        # ----------------------------------------------------
